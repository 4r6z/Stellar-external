...
namespace stellar {
    ...
    namespace offsets {
        ...
        inline constexpr uintptr_t size = ChildrenEnd;
        inline constexpr uintptr_t name = Name;
        inline constexpr uintptr_t displayname = DisplayName;
        ...
        inline constexpr uintptr_t model_instance = ModelInstance;
        inline constexpr uintptr_t primitive = Primitive;
        inline constexpr uintptr_t part_size = PartSize;
        inline constexpr uintptr_t position = Position;
        inline constexpr uintptr_t dimensions = Dimensions;
        inline constexpr uintptr_t move_direction = MoveDirection;
        inline constexpr uintptr_t classname = ClassDescriptor;
        inline constexpr uintptr_t health = Health;
        inline constexpr uintptr_t max_health = MaxHealth;
        inline constexpr uintptr_t walkspeed = WalkSpeed;
        inline constexpr uintptr_t jumpspeed = JumpPower;
        inline constexpr uintptr_t team = Team;
        inline constexpr uintptr_t gameid = GameId;
        inline constexpr uintptr_t velocity = Velocity;
        inline constexpr uintptr_t camera_pos = CameraPos;
        inline constexpr uintptr_t camera = Camera;
        inline constexpr uintptr_t camera_rotation = CameraRotation;
        inline constexpr uintptr_t walkspeed_a = WalkSpeed;
        inline constexpr uintptr_t walkspeed_b = WalkSpeedCheck;
        inline constexpr uintptr_t jumppower = JumpPower;
        inline constexpr uintptr_t hipheight = HipHeight;
        inline constexpr uintptr_t ping = Ping;
        inline constexpr uintptr_t value = Value;
        inline constexpr uintptr_t datamodel1 = DataModelToRenderView1;
        inline constexpr uintptr_t datamodel2 = DataModelToRenderView2;
        inline constexpr uintptr_t rotation = Rotation;
    }
}
